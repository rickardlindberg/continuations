...
multiToneCCode = unlines
    ...
    , "#define SIZE 5"
    , ""
    , "unsigned int pins[SIZE]       = {2, 3, 4, 0, 0};"
    , "unsigned int pinsActive[SIZE] = {0, 0, 0, 0, 0};"
    , "unsigned int toggles[SIZE]    = {0, 0, 0, 0, 0};"
    , "unsigned int counts[SIZE]     = {0, 0, 0, 0, 0};"
    , "unsigned int targets[SIZE]    = {0, 0, 0, 0, 0};"
    ...
    , "    clearAll();"
    , "    pinsActive[0] = 1;"
    , "    targets[0]    = (unsigned int)((1/one)/(2*64*0.000001));"
    , "    multiToneSetup();"
    , "    delay(tempo);"
    , "}"
    , ""
    ...
    , "    targets[0]    = (unsigned int)((1/one)/(2*64*0.000001));"
    , "    pinsActive[1] = 1;"
    , "    targets[1]    = (unsigned int)((1/two)/(2*64*0.000001));"
    , "    multiToneSetup();"
    , "    delay(tempo);"
    , "}"
    , ""
    ...
    , "    targets[1]    = (unsigned int)((1/two)/(2*64*0.000001));"
    , "    pinsActive[2] = 1;"
    , "    targets[2]    = (unsigned int)((1/three)/(2*64*0.000001));"
    , "    multiToneSetup();"
    , "    delay(tempo);"
    , "}"
    , ""
